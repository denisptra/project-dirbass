...
<body>
    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div id="right-sidebar" class="settings-panel">
                ...
                <div class="tab-content" id="setting-content">
                    <div class="tab-pane fade show active" id="todo-section" role="tabpanel"
                        ...
                        <div class="add-items d-flex px-3">
            ...
            <nav class="sidebar sidebar-offcanvas shadow-sm p-3 bg-body-tertiary" id="sidebar">
                <ul class="nav">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                ...
                                @endif
                                <li class="nav-item"> <a class="nav-link" href="{{ route('male.index') }}">Male</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('gallery-page.index') }}">
