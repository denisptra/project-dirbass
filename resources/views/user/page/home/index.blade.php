      ...
      <div class="col-12">
        <div class="row justify-content-center ">
          <div class="col-lg-9 text-center ">
            ...
            <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100" style="font-size: 60px;">"Difference To Be A Strong's"</h1>
          ...
          <div class="container">
            <div class="row justify-content-between">
              <div class="col-lg-5 mb-5">
                ...
                <p data-aos="fade-up" data-aos-delay="100">Dirbass (Difference to be a Strong's) is the 8th class at the Luhur Al-Tsaqafah Islamic Boarding School, Ciganjur, South Jakarta. Dirbass is a group committed to being a positive and strong difference in society.</p>
                ...
                <div class="row count-numbers mb-5">
                  <div class="col-4 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                    <span class="counter d-block"><span data-number="93">0</span><span>+</span></span>
  ...
  <div class="container">
    <div class="row justify-content-center mb-5">
      <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="0">
        ...
        <p>Stay up to date with our latest and comprehensive reports on activities.</p>
      </div>
    </div>
      <div class="row">
...
<div class="untree_co-section bg-light">
  <div class="container">
    <div class="row justify-content-center mb-5">
      <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="0">
        <h2 class="line-bottom text-center mb-4">Creation</h2>
        <p>Introducing a stunning Masterpiece of artistic brilliance.</p>
      </div>
    </div>
      <div class="row">
  ...
  <div class="container">
    <div class="row align-items-center justify-content-center text-center">
      <div class="col-lg-7">
        ...
        <p class="text-white h5 mb-4" data-aos="fade-up" data-aos-delay="100">“We are all unique in our own ways. Together, our differences make the world more beautiful.”</p>
    ...
    <div class="row mb-5">
      <div class="col-lg-4 mb-5 order-2 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
        <div class="contact-info">
           <img src="{{ asset('diet') }}/images/image/contact.png" alt="Image" class="img-fluid rounded mt-2" style="height:300px">
        </div>
      </div>
      <div class="col-lg-7 mr-auto order-1" data-aos="fade-up" data-aos-delay="200">
        <form action="#">
          <div class="row">
            ...
            <div class="col-12">
              <a href="" type="submit" value="Send Message" class="btn btn-primary">Send Message</a>
            </div>
          </div>
        </form>
      </div>
