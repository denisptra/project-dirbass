            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-transparent" style="display: flex; justify-content: center; margin-top: -50px;">
                ...
                <li class="breadcrumb-item active" aria-current="page" style="color: rgb(108, 108, 137);">
                    <a href="{{ route('news') }}" class="text-center" style="color: rgb(108, 108, 137);">News</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page" style="color: rgb(108, 108, 137);">Detail news</li>
              </ol>
            </nav>
            <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100" style="margin-top: -200px">Detail News</h1>
...
<div class="services-section">
  <h2 class="line-bottom text-center mb-4" style="margin-top: -2%">Detail News</h2>
