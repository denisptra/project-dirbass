...
<head>
  ...
  <link rel="icon" href="{{ asset('dist/images/db-rm.png') }}">
  <style>
    .site-menu li a {
      color: #333;
      ...
      <div class="container position-relative">
        <div class="site-navigation text-center">
          <a href="index.html" class="logo menu-absolute m-0">
            <img src="{{ asset('diet') }}/images/image/logo-putih.png" alt="" style="width: 50px; margin-top: -5px; border-radius: 50%;">
          </a>
      ...
      <div class="row">
        <div class="col-lg-4 mr-auto">
          <div class="widget">
            ...
            <p>Dirbass (Difference to be a Strong's) is the 8th class at the Luhur Al-Tsaqafah Islamic Boarding School, Ciganjur, South Jakarta. Dirbass is a group committed to being a positive and strong difference in society.</p>
          </div> <!-- /.widget -->
          <div class="widget">
            <h3>Connect</h3>
            <ul class="list-unstyled social">
              <li><a href="https://www.instagram.com/dir8ass/"><span class="icon-instagram"></span></a></li>
            </ul>
          </div> <!-- /.widget -->
        </div> <!-- /.col-lg-3 -->
        ...
        <div class="col-lg-4">
          <div class="widget">
            <h3>Contact</h3>
            <address> Jl. Moh.Kafi 1, Ciganjur, Jagakarsa Jakrta Selatan
            </address>
            <ul class="list-unstyled mb-4">
              <li>+62 897664466155</li>
              <li class="mt-3">+1(123)-456-7890</li>
              <li class="mt-3">dirbass281220@gmail.com</li>
            </ul>
          </div> <!-- /.widget -->
        </div> <!-- /.col-lg-3 -->
      ...
      <div class="row mt-5">
        <div class="col-12 text-center">
          <p>Copyright &copy;<script>
            ...
            </script>. All Rights Reserved. &mdash; Designed with love by <a href="#">Diskominfo</a> Distributed By <a
              href="#">Dirbass</a> 
        </div>
      </div>
    </div> <!-- /.container -->
